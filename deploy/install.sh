...
echo ""
echo "  Next steps:"
echo "    1. sudo vi ${CONFIG_DIR}/config.toml      # configure alerts, notifications"
echo "    2. sudo systemctl enable --now tori"
echo "    3. Install the client on your local machine and connect"
echo ""
echo "  Useful commands:"
echo "    sudo systemctl status tori    # check agent status"
echo "    journalctl -u tori -f         # follow agent logs"
echo "    sudo systemctl reload tori    # reload config (SIGHUP)"
echo ""
