...
func TestQueryMessagesRoundtrip(t *testing.T) {
	tests := []struct {
		...
		{"QueryLogsReq", TypeQueryLogs, &QueryLogsReq{Start: 1000, End: 2000, ContainerID: "abc", ContainerIDs: []string{"abc", "def"}, Search: "error", Level: "ERR", Limit: 500}},
		...
		{"TestNotifyReq", TypeActionTestNotify, &TestNotifyReq{RuleName: "high_cpu"}},
		{"SubscribeLogs", TypeSubscribeLogs, &SubscribeLogs{ContainerID: "abc", Project: "myapp", Search: "panic", Level: "ERR"}},
